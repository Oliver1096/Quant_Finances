...
<p align="center"> *The most common definition of a derivative reads approximately as follows*:


*A derivative is a finantial instrument that derives its performance from the performance of an underlying asset*.</p>
